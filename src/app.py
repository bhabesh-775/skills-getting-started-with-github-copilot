...
activities = {
    ...
    "Basketball Team": {
        "description": "Team practice and competitive games for student athletes",
    ...
    "Art Studio": {
        "description": "Painting, drawing, and creative workshops for artists",
    ...
    "Drama Club": {
        ...
        "max_participants": 20,
        "participants": ["scarlett@mergington.edu", "ethan@mergington.edu"]
    },
    "Math Olympiad": {
        "description": "Problem-solving sessions and competition prep for math enthusiasts",
